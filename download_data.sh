...
LABS=("BinaryTrees" "BreadthFirstSearch" "CVXPY_Intro" "DataVisualization" "FourierTransform" "GradientMethods" "InteriorPoint_Linear" "InteriorPoint_Quadratic" "LinkedLists" "MarkovChains" "MatplotlibIntro" "NearestNeighbor" "NumpyIntro" "PolynomialInterpolation" "RegularExpressions" "Simplex" "UnixShell2" "Wavelets")
